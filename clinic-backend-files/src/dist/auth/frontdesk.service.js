...
exports.FrontDeskStaffService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const frontdeskstaff_entity_1 = require("../entities/frontdeskstaff.entity");
let FrontDeskStaffService = class FrontDeskStaffService {
...
exports.FrontDeskStaffService = FrontDeskStaffService;
exports.FrontDeskStaffService = FrontDeskStaffService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(frontdeskstaff_entity_1.FrontDeskStaff)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], FrontDeskStaffService);
